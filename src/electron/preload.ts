...
const api = {
  ...
  attachSeleniumBasePatchright: (profileId: string) => ipcRenderer.invoke("attach-seleniumbase-patchright", profileId),
  navigateSeleniumBasePatchright: (profileId: string, url: string) => ipcRenderer.invoke("navigate-seleniumbase-patchright", profileId, url),
